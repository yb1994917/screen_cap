    ...
    public MinicapFrame() {
        ...
        mp.addMouseListener(new MouseListener() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                String command = String.format("input tap %d %d",  e.getX(),e.getY());
                System.out.println("touch command:"+command);
...
//                System.out.println("MyPanel realLen :"+realLen +  " buffer.length:"+buffer.length);
...
//                }
        ...
        public void paint(Graphics g) {
            try {
                if (image == null)
                    return;
                MinicapFrame.this.setSize(width, height+60);
